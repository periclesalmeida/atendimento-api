...
Funcionalidade: Chamar Novamente o Atendimento para a Localização
    O sistema permite que o usuário chame o atendimento novamente para a localização
  ...
  Cenario de Fundo:
   ...
   E que existem atendimentos cadastradas
       ...
       | 002 | 2                  | DATA_ATUAL_MENOS_1_MINUTO  |                   | DATA_ATUAL_MENOS_1_MINUTO| 002         | 003     | pericles | NÃO        |
  ...
  Cenário: Dado que foram informado localização com atendimento pendente
    Quando foi informado a localização "001" para o atendimento "002"
    ...
    E os detalhes do Atendimento são:
     ...
     | 002  | 2                  | DATA_ATUAL_MENOS_1_MINUTO       |                   | DATA_ATUAL         | 001         | pericles |     NÃO    | 003     |
